...
public class Lab4Main {
	...
	public static void TestB() {
		Athlete biden = new Athlete("6", "Joe", "Biden", Athlete.Gender.MALE, 25000);
		Athlete ardern = new Athlete("5", "Jacinda", "Ardern", Athlete.Gender.FEMALE, 13000);
		Athlete lincoln = new Athlete("32", "Abraham", "Lincoln", Athlete.Gender.MALE, 7000);
		Athlete siber = new Athlete("23", "Sibel", "Siber", Athlete.Gender.FEMALE, 30000);
		Athlete merkel = new Athlete("17", "Angela", "Merkel", Athlete.Gender.FEMALE, 40000);
		Athlete truman = new Athlete("55", "Harry", "Truman", Athlete.Gender.MALE, 18000);
		Athlete nixon = new Athlete("9", "Richard", "Nixon", Athlete.Gender.MALE, 50000);
		
		Team teamA = new Team("TeamA");
		teamA.addAthlete(Athlete.searchByJersey("17").get(0));
		teamA.addAthlete(Athlete.searchByJersey("5").get(0));
		teamA.addAthlete(Athlete.searchByJersey("23").get(0));
		teamA.setCaptain(Athlete.searchByJersey("17").get(0));
		
		Team teamB = new Team("TeamB");
		teamB.addAthlete(Athlete.searchByJersey("9").get(0));
		teamB.addAthlete(Athlete.searchByJersey("32").get(0));
		teamB.setCaptain(Athlete.searchByJersey("9").get(0));

		Team teamC = new Team("TeamC");
		teamC.addAthlete(Athlete.searchByJersey("6").get(0));
		teamC.addAthlete(Athlete.searchByJersey("55").get(0));
		teamC.setCaptain(Athlete.searchByJersey("6").get(0));
